 ...
 */
abstract class EntityContainer<T extends IdentifiableEntity> extends IdentifiableEntity implements IEntityContainer {
  ...
  public Map<String, T> getEntities() {
    ...
    // safe copy of the map
    return new java.util.HashMap<>(stringEntityMap);
  }
